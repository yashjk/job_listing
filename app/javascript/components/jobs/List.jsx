...
export default function List(props) {
  ...
  const timeAgo = (date) => {
    ...
    const now = new Date();
    const elapsedTime = (now - created_at) / (1000 * 60 * 60 * 24);
              ...
              <div className="row">
                ...
                <div className="col-5">
                  ...
                  <div className="row text-muted align-items-center">
                    <small>{timeAgo(job.created_at)} day ago</small>
                    <p className="m-2">.</p>
                ...
                <div className="row justify-content-center align-items-center col-5">
                  <Tag
                    style={{
